...
class Woolentor_Universal_Product_Widget extends Widget_Base {
                                        ...
                                        <div class="ht-product-inner">
                                                        ...
                                                        <div class="ht-product-image-slider ht-product-image-thumbnaisl-<?php echo esc_attr($tabuniqid); ?>">
                                                            <?php
                                                                ...
                                                                foreach ( $gallery_images_ids as $gallery_attachment_id ) {
                                                                    $i++;
                                                                    echo '<a  class="item '.($i === 1 ? 'ht-slider-first-item' : '').' ">'.wp_get_attachment_image( $gallery_attachment_id, 'woocommerce_thumbnail' ).'</a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                                                }
                                                            ?>
                                                        </div>
                                                    ...
                                                    <div class="ht-product-action">
                                                        <ul <?php echo $this->get_render_attribute_string( 'action_btn_attr' ); ?>>
                                                            <?php if( true === woolentor_has_quickview() ): ?>
                                                                <li>
                                                                    <a  class="woolentorquickview" data-product_id="<?php the_ID();?>" <?php echo wc_implode_html_attributes( ['aria-label'=>$product->get_title()] ); ?>>
                                            ...
                                            <div class="ht-product-content">
                                                <div class="ht-product-content-inner">
                                                    ...
                                                    <?php echo sprintf( "<%s class='ht-product-title'><a >%s</a></%s>", $title_html_tag, get_the_title(), $title_html_tag ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
    ...
    if ( $product && $product->is_type( 'variable' ) ) {
        ...
        // Get the minimum price from the array
        ...
        else
        {
           $min_price = 0;
                                            ...
                                            ?>
                                                <a  class="product_ests" data-product_id="<?php the_ID();?>" data-price="<?php echo $min_price?>" data-size="100x150"> 
                                                    <?php woocommerce_template_loop_product_thumbnail(); ?> 
                                                </a>
                                            <?php endif; ?>
                                    ...
                                    <div class="ht-product-content">
                                        <div class="ht-product-content-inner">
                                            ...
                                            <!-- 
                                                                              ...
                                                                              //echo //sprintf( "<%s class='ht-product-title'><a href='%s'>%s</a></%s>", $title_html_tag, get_the_permalink(), get_the_title(), $title_html_tag ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> -->
  
                                                                              <?php        
                                                                              
                                                                                                                                                    
echo sprintf(
    "<%s class='ht-product-title'><a href='#' class='product_ests' data-product-id='%d' data-price='%.2f' data-size='%s'>%s</a></%s>", 
    $title_html_tag, 
    get_the_ID(),
  $min_price,
  "100x150", // Use get_the_ID() to retrieve the product ID
    get_the_title(),  
